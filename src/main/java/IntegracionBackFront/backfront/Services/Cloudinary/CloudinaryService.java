...
public class CloudinaryService {
    ...
    //Subir imagenes a la raiz Cloudinary
    ...
    private void validateImage(MultipartFile file) {
        ...
        if (file.isEmpty()) throw new IllegalArgumentException("El archivo no puede estar vacío"); //1. Verificar si el archivo está vacío
        if (file.getSize() > MAX_FILE_SIZE) throw new IllegalArgumentException("El tamaño del archivo no puede exceder los 5MB"); //Verificar si el tamaño del archivo excede el límite permitido
        String originalFilename =file.getOriginalFilename();
